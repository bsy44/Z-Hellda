...
public class SchemaAttaqueBouleDeFeu extends SchemaAttaqueBoss {
    ...
    public void faireAttaque (Environnement environnement, Boss boss, String direction) {
        ...
        if (direction.equals("droite")) faireAttaqueDroite(environnement, boss);

        else if (direction.equals("gauche")) faireAttaqueGauche(environnement, boss);

        else if (direction.equals("bas")) faireAttaqueBas(environnement, boss);

        else faireAttaqueHaut(environnement, boss);
    }

    private void faireAttaqueDroite (Environnement environnement, Boss boss) {
    ...
    private void faireAttaqueGauche (Environnement environnement, Boss boss) {
        Timeline lancerBouleDeFeu = new Timeline(
                new KeyFrame(Duration.seconds(1), e -> {
    ...
    private void faireAttaqueBas (Environnement environnement, Boss boss) {
        Timeline lancerBouleDeFeu = new Timeline(
                new KeyFrame(Duration.seconds(1), e -> {
    ...
    private void faireAttaqueHaut (Environnement environnement, Boss boss) {
        Timeline lancerBouleDeFeu = new Timeline(
                new KeyFrame(Duration.seconds(1), e -> {
